...
function updateTheme(theme) {
    if(localStorage.getItem('auto-theme') === 'true'){
        ...
        $('#switch-dark-mode').removeClass('ring-[0.0500rem] ring-gray-400 bg-dark bg-opacity-10');
    ...
    $("html").removeClass('light').addClass('dark');
    $('#switch-dark-mode').addClass('ring-[0.0500rem] ring-gray-400 bg-dark bg-opacity-10');
    $('#switch-light-mode').removeClass('ring-[0.0500rem] ring-gray-400 bg-white bg-opacity-100');
    $("#switch-mode-auto").removeClass('ring-[0.0500rem] ring-gray-400 bg-dark bg-opacity-10 auto-switch');
    $('#dark-mode .light-mode-icon').hide();
    $('#dark-mode .dark-mode-icon').show();
  } else if(theme === 'light') {
    $('#dark-mode').removeClass('dark-mode').addClass('light-mode');
    $("html").removeClass('dark').addClass('light');
    $('#switch-light-mode').addClass('ring-[0.0500rem] ring-gray-400 bg-white bg-opacity-100');
    $('#switch-dark-mode').removeClass('ring-[0.0500rem] ring-gray-400 bg-dark bg-opacity-10');
    $("#switch-mode-auto").removeClass('ring-[0.0500rem] ring-gray-400 bg-dark bg-opacity-10 auto-switch');
