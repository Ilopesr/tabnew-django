...
class CommentUpdateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field in self.fields:
            if field == 'description':
                self.fields[field].widget.attrs['class'] = 'h-[100px] py-3 resize-none w-full outline-blue-500 focus:ring-blue-500 focus:border-blue-500 rounded-md  bg-gray-100 ring-[1px] ring-gray-500 ring-opacity-40 dark:bg-darkInput dark:text-white p-4'
